...
public class AuthService {
    ...
    private AuthToken applyToken (String username, String password, String clientId, String clientSecret) {
        ...
        //找到auth微服务,调用其spring security 的鉴权
        ResponseEntity<Map> exchange = restTemplate.exchange(authUrl, HttpMethod.POST, httpEntity, Map.class);

        //auth微服务鉴权之后,申请令牌信息,不符合条件就是账号或密码错误
    ...
    public AuthToken getUserToken (String access_token) {
        ...
        if (userToken != null) {
            ...
            try {
                ...
                log.error("getUserToken from redis and execute JSON.parseObject error {}",
                        e.getMessage());
                e.printStackTrace();
            }
            return authToken;
    ...
    public boolean delToken (String tokenFormCookie) {
        stringRedisTemplate.delete("user_token:"+tokenFormCookie);
        return true;
    }
}

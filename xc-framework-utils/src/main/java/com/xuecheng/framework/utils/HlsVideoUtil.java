...
public class HlsVideoUtil extends  VideoUtil {
    ...
    String ffmpeg_path = "D:\\soft\\ffmpeg-20180227-win64\\bin\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\xc\\video\\lucene.avi";
    String m3u8_name = "lucene.m3u8";
    String m3u8folder_path = "D:/xc/video/test/";

...
public class MediaProcessTask {
    ...
    public void receiveMediaProcessTask (String msg) throws IOException {
        ...
        if (!optional.isPresent()) {
            ExceptionCast.cast(MediaCode.FILE_NOT_FOUND);
        }
        ...
        if ("avi".equals(fileType)) {
            ...
            this.aviToMp4(mediaFile);
            this.createM3u8(mediaFile);
    ...
    private void createM3u8 (MediaFile mediaFile) {
        String mp4_name = mediaFile.getFileId() + ".mp4";
        //此地址为mp4的地址
        String video_path = serverPath + mediaFile.getFilePath() + mp4_name;
    ...
    private void aviToMp4 (MediaFile mediaFile) {
        //生成mp4

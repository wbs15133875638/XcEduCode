...
public enum MediaCode implements ResultCode {
    ...
    UPLOAD_FILE_REGISTER_ISNULL(false,22007,"chunk文件不存在"),
    CHUNK_FILE_UPLOAD_FAIL(false,22008,"chunk文件上传失败"),
    MERGE_FILE_CREATEFAIL(false,22009,"合并文件创建失败"),
    FILE_NOT_FOUND(false,22010,"找不到对应的文件");

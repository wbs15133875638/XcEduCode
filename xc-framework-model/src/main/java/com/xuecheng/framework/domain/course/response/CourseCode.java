...
public enum CourseCode implements ResultCode {
    ...
    COURSE_NOT_FOUND_ERROR(false,31108,"选择的媒资文件名称为空！"),
    COURSE_MARKET_NOT_FOUND(false,31108,"查询的课程营销信息不存在！"),
    COURSE_INFO_NOT_FOUND_ERROR(false,31009,"根据课程id无法查到对应资源"),
    COURSE_TEACHPLAN_NOT_FOUND(false,31010,"无法根据课程计划id找到对应课程"),
    COURSE_TEACHPLAN_GRADE_ERROR(false,31011,"课程计划的叶子结点不是三级节点");
    //操作代码

...
public enum AuthCode implements ResultCode {
    ...
    AUTH_LOGIN_ERROR(false,23006,"权限校验失败,请重新登录之后尝试！"),
    AUTH_LOGIN_AUTHSERVICE_NOTFOUND(false,23007,"授权微服务实例未找到"),
    AUTH_LOGIN_APPLYTOKEN_FAIL(false,23008,"远程获取token失败"),
    AUTH_LOGIN_TOKEN_SAVEFAIL(false,23009,"保存token失败"),
    AUTH_CLEAR_REDIS_TOKEN_ERROR(false,23010,"清除redis令牌失败"),
    AUTH_CLEAR_COOKIE_ERROR(false,23011,"清除cookie失败");
